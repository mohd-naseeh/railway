           ...
           <div class="box_header">
             ...
             ?>
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<td>";
                  echo "<form method='post' action='deleteuser.php' onsubmit='return confirmDelete()'>"; // Adjust the action attribute based on your backend logic
                  echo "<input type='hidden' name='id' value='" . $row["id"] . "'>";
                  echo "<button type='submit'>DELETE</button>";
                  echo "</form>";
                  echo "</td>";
                  echo "<td>";
                  echo "<form method='post' action='viewticket.php?id=" . $row["id"] . "' >"; // Adjust the action attribute based on your backend logic
                  echo "<input type='hidden' name='id' value='" . $row["id"] . "'>";
