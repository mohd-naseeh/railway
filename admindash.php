              ...
              <div class="box_body">
                <table width="100%">
                 ...
                 while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<td>" . $row["date"] . "</td>";
                  echo "<td>";
                  echo "<form method='post' action='deltrain.php' onsubmit='return confirmDelete()'>"; // Adjust the action attribute based on your backend logic
